...
export const subcategoryFields = [
    ...
    { name: "rentPerPiece", label: "Rent per piece per day", type: "text", placeholder: "Rent per piece per day" },
    { name: "depositPerPiece", label: "Deposit per piece per day", type: "text", placeholder: "Deposit per piece per day" },
